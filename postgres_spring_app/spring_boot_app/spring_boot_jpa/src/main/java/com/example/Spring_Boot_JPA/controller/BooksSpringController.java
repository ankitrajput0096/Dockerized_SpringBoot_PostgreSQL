...
public class BooksSpringController {
    ...
    public ResponseEntity<List<TopicDto>> listOfTopics() {
        return ResponseEntity.ok().body(this.booksAndTopicsSpringService.getAllTopicsDtos());
    }

    @RequestMapping(value = "/topics/{id}")
    public ResponseEntity<TopicDto> getRequiredTopic(@PathVariable String id) {
        return ResponseEntity.ok().body(this.booksAndTopicsSpringService.getTopicDto(id));
    }
    ...
    public ResponseEntity<String> addTopic(@RequestBody TopicDto topicDto) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body("the new topic is created with details :" + topicDto.toString());
    }

    @RequestMapping(value = "/topics/update/{id}", method = RequestMethod.PUT)
    public ResponseEntity<String> updateTopic(@RequestBody TopicDto topicDto, @PathVariable String id) {
        this.booksAndTopicsSpringService.updateTopicDto(topicDto, id);
        return ResponseEntity.status(HttpStatus.FOUND).body("the existing topic is updated with details :" + topicDto.toString());
    }
    ...
    public ResponseEntity<String> deleteTopic(@PathVariable String id) {
        ...
        return ResponseEntity.ok().body("the topic is successfully deleted with id : " + id);
    }

    //Url "localhost:8080/springBootJpa/topics/getById?id=java
    @RequestMapping(value = "/topics/getById", method = RequestMethod.GET)
    public ResponseEntity<TopicDto> getById(@RequestParam(value = "id") String id) {
        return ResponseEntity.ok().body(this.booksAndTopicsSpringService.getByIdDto(id));
    }

    @RequestMapping(value = "/topics/getByIdAndName", method = RequestMethod.GET)
    public ResponseEntity<TopicDto> getByIdAndName(@RequestParam(value = "id") String id, @RequestParam(value = "name") String name) {
        return ResponseEntity.ok().body(this.booksAndTopicsSpringService.getByIdAndNameDto(id, name));
    }


    @RequestMapping(value = "/books")
    public ResponseEntity<List<BookDto>> listOfBooks() {
        return ResponseEntity.ok().body(this.booksAndTopicsSpringService.getAllBookDtos());
    }

    @RequestMapping(value = "/books/{id}")
    public ResponseEntity<BookDto> getRequiredBook(@PathVariable String id) {
        return ResponseEntity.ok().body(this.booksAndTopicsSpringService.getBookDto(id));
    }
    ...
    public ResponseEntity<String> addBook(@RequestBody BookDto bookDto) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body("the new book is created with details :" + bookDto.toString());
    }

    @RequestMapping(value = "/books/update/{id}", method = RequestMethod.PUT)
    public ResponseEntity<String> updateBook(@RequestBody BookDto bookDto, @PathVariable String id) {
        this.booksAndTopicsSpringService.updateBookDto(bookDto, id);
        return ResponseEntity.status(HttpStatus.FOUND).body("the existing book is updated with details :" + bookDto.toString());
    }
    ...
    public ResponseEntity<String> deleteBook(@PathVariable String id) {
        ...
        return ResponseEntity.ok().body("the book is successfully deleted with id : " + id);
    }
    ...
    public ResponseEntity<String> transactionScenarioOne() {
        ...
        return ResponseEntity.ok().body("Transaction scenario one : testing roll back using Runtime error");
    }
    ...
    public ResponseEntity<String> transactionScenarioTwo() {
        ...
        return ResponseEntity.ok().body("Transaction scenario two : testing roll back using java exception error");
    }
    ...
    public ResponseEntity<String> transactionScenarioThree() {
        ...
        return ResponseEntity.ok().body("Transaction scenario three : testing no roll back using java arithmetic exception error");
    }
    ...
    public ResponseEntity<String> transactionScenarioFour() {
        ...
        return ResponseEntity.ok().body("Transaction scenario four : testing roll back using java exception error for certain db transaction on " +
